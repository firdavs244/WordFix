"""
Custom exception classes for WordFix API.

Domain-driven exceptions that are independent of HTTP/Django/DRF.
Pure Python — safe to import from any layer (domain, application, etc.).
The exception_handler module converts these to HTTP responses.
"""
